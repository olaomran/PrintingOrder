...
namespace PrintingOrder.Migrations
{
    ...
    [Migration("20250922081221_newMigDBValidators")]
    partial class newMigDBValidators
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrintingOrder.Models.DeliveryToStore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PrintingOrder.Models.PrintOrder", b =>
                {
                    ...
                    b.Property<int>("DeliveriedCopiesToStore")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PrintingOrder.Models.PrintOrderDelivery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DeliverdAmount")
                        .HasColumnType("int");

                    b.Property<int?>("DeliveryId")
                        .HasColumnType("int");

                    b.Property<int?>("DeliveyToStoreId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DeliveyToStoreId");

                    b.HasIndex("PrintOrderId");

                    b.ToTable("PrintOrderDelivery");
                });
            ...
            modelBuilder.Entity("PrintingOrder.Models.PrintOrderDelivery", b =>
                {
                    b.HasOne("PrintingOrder.Models.DeliveryToStore", "DeliveyToStore")
                        .WithMany("PrintOrderDeliveries")
                        .HasForeignKey("DeliveyToStoreId");

                    b.HasOne("PrintingOrder.Models.PrintOrder", "PrintOrder")
                        .WithMany("PrintOrderDeliveries")
                        .HasForeignKey("PrintOrderId");

                    b.Navigation("DeliveyToStore");
            ...
            modelBuilder.Entity("PrintingOrder.Models.ProductionConsumedItem", b =>
                {
                    ...
                    b.HasOne("PrintingOrder.Models.MachineProduction", "MachineProduction")
                        .WithMany("ProductionConsumedItems")
                        .HasForeignKey("MachineProductionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PrintingOrder.Models.DeliveryToStore", b =>
                {
                    b.Navigation("PrintOrderDeliveries");
                });
